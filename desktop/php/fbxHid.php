...
sendVarToJS('eqType', 'fbxHid');
$eqLogics = eqLogic::byType('fbxHid');
?>
		...
		<div class="eqLogicThumbnailContainer">
			...
			?>
				...
				foreach ($eqLogics as $eqLogic) {
					...
					echo "<center>";
					echo '<img src="plugins/fbxHid/doc/images/fbxHid_icon.png" height="105" width="95" />';
					echo "</center>";
...
<?php include_file('desktop', 'fbxHid', 'js', 'fbxHid'); ?>
